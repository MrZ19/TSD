...
from models.architectures_ori import KPFCNN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--chosen_snapshot', default='D3Feat_ori10071648', type=str, help='snapshot dir')
    ...
    parser.add_argument('--num_points', default=2500, type=int)
